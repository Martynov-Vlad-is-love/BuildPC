...
class ModelUtil {
  static final Map<String, Function> modelMapping = {
    ...
    'Motherboard': (List<dynamic> values) => Motherboard(
          ...
          ramMemoryType: values[11] as RamMemoryType,
          network: values[12] as MotherboardNetwork,
          bluetooth: values[13] as bool,
          wifi: values[14] as bool,
          pcieVersion: values[15] as CPUPCIeVersion,
          pciExpressX16: values[16] as int,
          pciExpressX4: values[17] as int,
          pciExpressX1: values[18] as int,
          sata3: values[19] as int,
          m2: values[20] as int,
          dsub: values[21] as bool,
          dvi: values[22] as int,
          hdmi: values[23] as int,
          displayPort: values[24] as int,
          usb_3_0: values[25] as int,
          usb_2_0: values[26] as int,
          usbTypeC: values[27] as int,
          digitalAudioJack: values[28] as bool,
          description: values[29] as String,
          recommendedPrice: values[30] as int,
          performanceLevel: values[31] as PerformanceLevel,
        ),
